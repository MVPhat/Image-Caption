...
<div style="padding-bottom: 15px">
    <div style="display: flex; width: 100%; gap: 10px;">
        <img src="https://drive.google.com/uc?id=1ZzktZ7x56W5Uk9t4Nik4aVvAd4xBfsgV" style="width: 50%; height: 50%"/>
        <div style="padding-left: 10px">
            <p>Some our ground truth captions:</p>
            <div style="color: green">"Three people are sitting next to and one of them is holding the camera."</div>
            <div style="color: green">"A group of people are smiling and posing in front of the camera."</div>
            <div style="color: green">"Three men wearing the glasses are looking at the camera."</div>
        </div>
    </div>
...
## <a id="part4"></a> IV. Fine-tuning And Futher Experiments
...
<div style="padding-bottom: 15px">
    ...
    <p style="display: flex; width: 100%; gap: 10px;">
        <img src="https://drive.google.com/uc?id=1ZzktZ7x56W5Uk9t4Nik4aVvAd4xBfsgV" style="width: 50%;"></img>
        <img src="https://drive.google.com/uc?id=1-x9-7CzwoKuuvXwglC2JivYBpShLMXOq" style="width: 50%; height: 50%"/>
    </p>
